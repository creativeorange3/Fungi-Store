  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                ...
                <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm">Drag & Drop a File</p>
        ...
        <h2 className=" mt-3 font-poppins dark:text-white text-nft-black-1 font-normal text-sm">
          <b>IMPORTANT</b> Once you put up your NFT for sale, in the beta version of our marketplace you won't be able to take it down.
        </h2>

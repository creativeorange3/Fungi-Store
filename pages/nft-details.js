...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetweenStart my-5">
      ...
      <div>
        <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">{nft.price}
          <span className="font-semibold"> {nftCurrency}</span>
        </p>
      </div>
    </div>
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-base minlg:text-xl">Total
      </p>
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">{nft.price}
        <span className="font-semibold"> {nftCurrency}</span>
      </p>
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase()
            ? (
              <p className="border border-gray p-2 font-poppins dark:text-white text-nft-black-1 text-base font-normal">
      ...
      {isLoadingNFT && (
        <Modal
          header="Buying NFT..."
          body={(<div className="flexCenter flex-col text-center"><div className="relative w-52 h-52"><Loader /></div></div>)}

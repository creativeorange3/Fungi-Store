...
const SearchBar = ({ activeSelect, setActiveSelect, handleSearch, clearSearch }) => {
  ...
  return (
    <>
      <div className="py-3 flex-1 flexCenter dark:bg-nft-black-2 bg-white dark:border-nft-black-2 border-nft-gray-2 px-4 rounded-md">
      ...
      <div
        ...
        className="relative flexBetween ml-4 sm:ml-0 sm:mt-2 min-w-190 cursor-pointer py-3
             dark:bg-nft-black-2 bg-white dark:border-nft-black-2 border-nft-gray-2 px-4 rounded-md"
      >
        ...
        />
        {toggle && (
        <div className="absolute top-full left-0 right-0 w-full mt-3 z-10 dark:bg-nft-black-2 bg-white dark:border-nft-black-2 border-nft-gray-2
